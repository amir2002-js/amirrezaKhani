...
export default function MobileMenu({ changeMenuState, showMenu, isVisible }) {
	return (
		<>
			{isVisible && (
				<div className={`fixed top-0 w-full h-svh flex z-50`}>
					{/* link Nav */}
					<div
					...
					>
						<Menu changeMenuState={changeMenuState} showMenu={showMenu} />
					</div>

					{/* close side menu */}
					<div
						className={`w-screen transition-all duration-300 ${
							!showMenu ? "bg-black/0" : "bg-black/30"
						}`}
